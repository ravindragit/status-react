...
(def component-styles
  {:status-bar            {:default     {:height    0
   ...
   :toolbar               {:height         55
                           ...
                           :padding-left   16
                           :padding-right  14}
   :toolbar-title-container {:padding-left   32}
   ...
   :contacts              {:subtitle     {:color     styles/color-gray4
                           ...
                           :contacts-list-container {:background-color styles/color-white
                                                     :padding-top    8
                                                     :padding-bottom 8}
                           :separator    {:height 0}
                           ...
                           :show-all-text {:fontSize       14
                                           ...
                                           :letter-spacing 0.5}
                           :contact-container {:padding-right 14}
...
(def platform-specific
  {:component-styles             component-styles
   ...
   :group-name-input-container   {:padding-right 16}
